...
INSERT INTO compliance_items (
  ...
  urgency, affected_entities,
  publication_date, effective_date, detected_at, published
) VALUES

-- 1. HRSA 340B Program Ceiling Price Final Rule (2017, still operative)
(
  'fr-2017-00722',
  'federal_register',
...
-- 2. HRSA Contract Pharmacy Dispute Resolution Final Rule (2023)
(
  'fr-2023-14428',
  'federal_register',
...
-- 3. HRSA Omnibus Guidance Repeal Notice (2017)
(
  'fr-2017-07712',
  'federal_register',
...
-- 4. Contract Pharmacy Manufacturer Restrictions Notice (2021)
(
...
-- 5. 340B Program Integrity Final Rule (2024)
(
...
-- 6. OPAIS Registration Requirement Reminder
(
...
-- 7. Duplicate Discount Prohibition Guidance Update
(
...
-- 8. 340B Coalition Comment Period Notice
(
